Feature: CAMARA MaaS Knowledge base API, v0.1.0-rc.1
  ...
  @knowledge_base_create_fail_missing_name
  ...
  @knowledge_base_get_fail_not_exist
  ...
  @knowledge_base_update_fail_invalid_id
  ...
  @knowledge_base_upload_file_fail_invalid_format
  ...
  @knowledge_base_upload_file_fail_not_exist_base
  ...
  @knowledge_base_fail_server_error
